    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="{{ asset('assets/img/MOMONA2.jpg')}}" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold text-danger">MOMONA CAFE</span></h4>
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">         
                ...
                @elseif ($now >= 18)
                  Konbanwa
                @endif</h1>
                <h5 class="font-weight-normal text-muted-transparent">Jawa timur, Indonesia</h5>
              </div>
